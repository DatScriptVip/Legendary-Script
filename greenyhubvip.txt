...
local Plr = Players.LocalPlayerTiktok
...
v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://104010252432994", BackgroundTransparency = 0 },
    Size = UDim2.new(0, 35, 0, 35),
    Corner = { CornerRadius = UDim.new(0.25, 0) },
})

local v484 = v466:MakeTab({"Tiktok", "info"})
...
v484:AddTiktokInvite({
    Name = "GreenY Hub | Community",
    Description = "Follow TikTok to receive Update",
    Logo = "rbxassetid://133599588183558",
    Invite = "https://www.tiktok.com/@dat_script.vip"
})
                                    ...
                                    if not l_Character_7:FindFirstChild("Tushita") and not l_Backpack_1:FindFirstChild("Tushita") then
                                        if not v798 then
                                            game.StarterGui:SetCore("SendNotification", {
                                                ...
                                                con = "rbxassetid://104010252432994",
                                                Duration = 10
                                            })
                                            v798 = true
                                        end
